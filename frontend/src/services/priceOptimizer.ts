...
/**
 * Product details interface for price optimization
 */
 ...
 */
export const getOptimizedPrice = async (productDetails: ProductDetails): Promise<number> => {
 ...
 */
function buildPrompt(productDetails: ProductDetails): string {
 ...
 */
function extractPrice(priceText: string, fallbackPrice: number): number {
